...
Define the per-row inline tags shown after the estimate/customer name in the Conversions channel roll-up: a house-call lead-source tag and a call-vs-booking tag, both rendered in a light, inline pill style.
