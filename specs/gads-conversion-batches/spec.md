# gads-conversion-batches

## Purpose

Track every Google Ads `uploadClickConversions` API call as a batch row, link constituent upload rows to their batch, and surface batches in a Workbench panel for inspection.
