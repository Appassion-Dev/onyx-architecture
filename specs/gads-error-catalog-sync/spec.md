# gads-error-catalog-sync

## Purpose

Maintain a vendored JSON catalog of Google Ads API error enums, regenerated deterministically from pinned protobuf sources and shared by both the edge function and the dashboard with no runtime parsing.
